...
###19.4.1 Pre-splitting tables with the HBase Shell
...
上面的例子中，表‘t1’将包含column family ‘f’，pre-split成四个区域。注意第一个区域将包含从‘\x00’到‘\x30’的所有keys（as '\x31' is the ASCII code for '1'）
