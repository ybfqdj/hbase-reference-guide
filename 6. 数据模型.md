...
> 按照惯例，一个column名字是由comlumn family前缀和一个qualifier组成。例如，列_contents:html_是由column family _contents_ 和 qualifier_html_组成。‘冒号：’从column family qualifier中限定来column family
